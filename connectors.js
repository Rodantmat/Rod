...
(() => {
  ...
  function getActiveApiKey() {
    ...
    if (activeKey) {
      window.__OXYGEN_GEMINI_KEY__ = activeKey;
      try { localStorage.setItem('OXYGEN_GEMINI_KEY', activeKey); } catch (_) {}
      try { sessionStorage.setItem('OXYGEN_GEMINI_KEY', activeKey); } catch (_) {}
    }
    return activeKey;
  }
