...
7. Confirm version shows v1.4.05 - RBI Under Hard Risk Caps.
...
WHERE slate_date = '2026-05-05'
  AND model_version = 'v1.4.05 - RBI Under Hard Risk Caps'
