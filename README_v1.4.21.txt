AlphaDog/OXYGEN-COBALT v1.4.21 - Dispatch Alias Slate Fix
...
2. Open Control Room > DEBUG > Health. Confirm version v1.4.21 and odds_api_key_bound=true.
