const SYSTEM_VERSION = 'v0.1.19 - Prop Definitions Reset Pipeline Fix';
...
<div class="top"><h1>AlphaDog Expansion Control Room</h1><div class="version">v0.1.19 - Prop Definitions Reset Pipeline Fix</div><div class="small" id="originStatus">Starting UI...</div><div class="status" id="actionStatus">Ready.</div></div>
