const SYSTEM_VERSION = 'v0.1.20 - Set-Based Context Builder';
...
<div class="top"><h1>AlphaDog Expansion Control Room</h1><div class="version">v0.1.20 - Set-Based Context Builder</div><div class="small" id="originStatus">Starting UI...</div><div class="status" id="actionStatus">Ready.</div></div>
