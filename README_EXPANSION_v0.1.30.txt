ALPHADOG EXPANSION v0.1.30 - Button Wiring Hard Lock
...
2. Confirm header shows v0.1.30 - Button Wiring Hard Lock
3. Tap Button Self Test. Expected: button_wiring PASS_INLINE_ONCLICK_ACTIVE.
4. Tap Health. Expected: HTTP 200 and version v0.1.30.
