AlphaDog v1.2.37 - Slate-Scoped Failure Filter
...
v1.2.37 surgical change:
- Daily Health current_active_failure_rows is now scoped to the requested slate_date.
- Failures/stale rows from other slate dates are historical only and do not block current Daily Health.
- RFI regression, candidate scoring, and database schema are untouched.
