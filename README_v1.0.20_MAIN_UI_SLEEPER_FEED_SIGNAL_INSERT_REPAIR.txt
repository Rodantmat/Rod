AlphaDog Main UI v1.0.20 - Sleeper Feed Signal Insert Repair
...
PATCH v1.0.20:
- Fixed sleeper_rbi_rfi_market_signals INSERT placeholder mismatch: 21 columns now have 21 values.
- Sleeper Feed save no longer fails with D1_ERROR: 20 values for 21 columns.
